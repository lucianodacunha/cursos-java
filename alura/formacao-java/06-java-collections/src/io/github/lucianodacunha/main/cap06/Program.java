package io.github.lucianodacunha.main.cap06;
...
public class Program {
	...
	public static void main(String[] args) {
		...
		Set<String> students = Collections.emptySet();
		// students.add(faker.funnyName().name()); java.lang.UnsupportedOperationException 
	}
