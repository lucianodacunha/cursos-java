...
public class Program {
    public static void main(String[] args){
        ...
        ContaKripto ck = (ContaKripto) getContaKripto(faker);
    ...
    static Conta getContaKripto(Faker faker){
        return new ContaKripto(
            faker.number().numberBetween(1000, 9999),
            faker.number().numberBetween(1000, 9999),
            new Cliente(faker.name().firstName()));
    }        
...
class ContaKripto extends Conta implements Tributavel {

    public ContaKripto(int agencia, int numero, Cliente titular){
        super(agencia, numero, titular);
    }
    ...
    @Override
    public String toString(){
        return String.format("Tipo: CK, %s", super.toString());
    }    
}
...
class CalculadorDeImpostos {
    private double totalDeImpostos = 0d;

    public void calculaImposto(Tributavel tributavel){
        this.totalDeImpostos += tributavel.getImposto();
    }
    ...
    public String toString(){
        return String.format("Total de Impostos: %.2f", 
            this.getTotalDeImpostos());
    }
}